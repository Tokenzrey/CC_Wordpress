      ...
      <Router>
        ...
        <Routes>
          ...
          <Route element={<PublicLayout />}>
            ...
            {/* New Pages */}
            <Route path="/resources/security-whitepaper" element={<SecurityWhitepaperPage />} />
            
            {/* Community Forum Routes */}
            <Route path="/resources/community/forum" element={<ForumPage />} />
            <Route path="/resources/community/discuss/:id" element={<DiscussionPage />} />
          </Route>
          ...
          <Route element={<RequireAuth />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route element={<RequireSubscription requiredPlan="enterprise" />}>
                <Route path="/dashboard/audit-logs" element={<div className="p-8"><h1>Enterprise Audit Logs</h1></div>} />
              </Route>
            </Route>
          </Route>
