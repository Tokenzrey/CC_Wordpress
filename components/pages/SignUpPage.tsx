...
import { Box, Lock, Mail, User, ArrowRight, Eye, EyeOff, Loader2 } from 'lucide-react';
...
export const SignUpPage: React.FC = () => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      localStorage.setItem('wpcube_auth', 'true');
      setLoading(false);
      navigate('/dashboard');
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-2xl font-bold text-gray-900">Start your 14-day free trial</h2>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-brand-500 focus:border-brand-500 block w-full pl-10 pr-10 sm:text-sm border-gray-300 rounded-md py-2 border ${errors.password ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-brand-500 focus:border-brand-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2 border ${errors.password ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                  placeholder="••••••••"
                />
              </div>
              {errors.password && (
